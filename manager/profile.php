...
$urlProfile = $_SERVER['REQUEST_URI'];
$data=$_POST;
if (isset($data['passwordButton'])) {
    ...
    if (empty($errors)) {
        ...
        $dbProd->query("UPDATE `accounts` SET `password` = '$password' WHERE `username` = '$login'");
...
if (isset($data['loginButton'])) {
    ...
    if (empty($errors)) {
        ...
        $dbProd->query("UPDATE `accounts` SET `username` = '$loginForm' WHERE `username` = '$login'");
        $message = "Логин изменён";
        $color = 'alert-success';
        exit("<meta http-equiv='refresh' content='0; url= $urlProfile'>");
    }else {
        $message = array_shift($errors);
        $color = 'alert-danger';
    }
...
if (isset($data['accessButton'])) {
        ...
        $dbProd->query("UPDATE `accounts` SET `type_user` = '$accessForm' WHERE `username` = '$login'");
        exit("<meta http-equiv='refresh' content='0; url= $urlProfile'>");
};
if (isset($data['colorInterfaceButton'])) {
    $colorInterfaceForm = $data['color'];
    $dbProd->query("UPDATE `accounts` SET `colorinterface` = '$colorInterfaceForm' WHERE `username` = '$login'");
    exit("<meta http-equiv='refresh' content='0; url= $urlProfile'>");
}
?>
            ...
            <div class="col-lg-12 mb-4">
                <div class="card wow slideInLeft <?php echo $bgColorCard?>">
                    <div class="card-body">
                        ...
                        <div class="card-text">
                            <a href="#" class="<?php echo $colorTextContant?>" data-toggle="modal" data-target="<?php if ($typeUser=="user") {echo "#";}?>#password">
                            ...
                            <a href="#" class="<?php echo $colorTextContant?>" data-toggle="modal" data-target="<?php if ($typeUser=="user") {echo "#";}?>#login">
                                <div class="container-fluid p-2 pt-3 border-bottom border-light waves-effect pl-4">
                                    <div class="row">
                            ...
                            <a href="#" class="<?php echo $colorTextContant?>" data-toggle="modal" data-target="<?php if ($typeUser=="user") {echo "#";}?>#access">
                                <div class="container-fluid p-2 pt-3 border-bottom border-light waves-effect pl-4">
                                    <div class="row">
